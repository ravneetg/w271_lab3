...
PINCP_log ~ AGEP_bin + factor(SCHL_bin) + WKHP + I(WKHP**2)
...
lmod2 = lm(PINCP_log ~ AGEP_bin + factor(SCHL_bin) + WKHP + I(WKHP**2), data=acs.trainingdata)
summary(lmod2)
...
lmod3 = lm(PINCP_log ~ AGEP_bin + factor(SCHL_bin) + WKHP +  I(WKHP**2) + JWMNP_bin, data=acs.trainingdata)
summary(lmod3)
...
lmod4 = lm(PINCP_log ~ AGEP_bin + factor(SCHL_bin) + WKHP +  I(WKHP**2) + JWMNP_bin + MAR_bin, data=acs.trainingdata)
summary(lmod4)
