...
We will run each of our models through the following runDiagnostics helper function.  This function will use formal statistical tests to validate most of the OLS assumptions. The function will also produce residual and other diagnostic plots when the trainning set is small enough.
...
##Modeling
We start building a parcimonious model while selecting features based on EDA and intuition.
...
First, let's estabalish a baseline of just using the mean of PINCP_l. 
...
lmod1: Creating first model with # of years of school education and age of the person. Based on intuition and EDA, these seem like features that would influence income of a person.
