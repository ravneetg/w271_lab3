...
Model 3(lmod3): In Model 3 we add in the Travel Time to Work (JWMNP) variable. The R-squared value increases slightly to 0.45, and the overall model remains highly significant. The AIC test indicates a lower Akaike score for model 3, so we decided to keep this variable in the model.
