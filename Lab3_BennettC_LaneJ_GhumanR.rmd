...
Model 4 (lmod4): At this point, we added the marital status variable to the model and evaluated the results. The R-squared increased ever so slightly, as did the AIC test. 
