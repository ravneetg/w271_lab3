...
* AGP: Independent variable
* SEX: Independent variable.  Transform to binary
* MAR: Independent variable.  Transform to categorical
* MARHT: Conditional: Transform NA values to 0, check correaltion with MAR
* MARHYP:
...
######################################################
acsTransformed$INDP = acs$INDP
acsTransformed$INDP = getOnlyHighDev(acsTransformed,"INDP",1)
...
acsTransformed$ANC1P = acs$ANC1P
acsTransformed$ANC1P = getOnlyHighDev(acsTransformed,"ANC1P",1)
