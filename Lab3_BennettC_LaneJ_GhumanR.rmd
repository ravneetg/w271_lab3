...
##Model training
This section helps split the dataset into training and test, so that back testing can be done on the  models for validation.
Training data has about 2.2M records and Testdata has about 28k. There is a small version of TestData that has 60 records. A smaller version was created to help plot the points and easily have a visual reference between predicted and actual values.
